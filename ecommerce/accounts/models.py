...
class EmailActivation(models.Model):
    ...
    def send_activation(self):
        if not self.activated and not self.forced_expired:
            if self.key:
                base_url = getattr(settings, 'BASE_URL', 'https://rafa-ecommerce.herokuapp.com/')
...
class GuestEmail(models.Model): # este es el model que guarda los mails de los usuarios invitados, a los que no se les pide tener un perfil, solo un mail
    email       = models.EmailField()
