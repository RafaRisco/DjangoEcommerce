$(document).ready(function(){
  ...
  var stripeModuleBtnTitle = stripeFormModule.attr("data-btn-title") || "Add cart"
  ...
  var btnLoadDefatultHtml = btnLoad.html()
  var btnLoadDefatultClasses = btnLoad.attr("class")
  ...
  function displayBtnStatus(element, newHtml, newClasses, loadTime, timeout){
    ...
    element.removeClass(btnLoadDefatultClasses)
    element.addClass(newClasses)
    return setTimeout(function(){
      element.html(btnLoadDefatultHtml)
      element.removeClass(newClasses)
      element.addClass(btnLoadDefatultClasses)
    }, loadTime)
  }
...
function stripeTokenHandler(nextUrl, token){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      btnLoad.html(btnLoadDefatultHtml)
      btnLoad.attr('class', btnLoadDefatultClasses)
